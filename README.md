...
#### 1. Creating issues  
All issues must be created using one of our issue templates, located in [ISSUE_TEMPLATE]((https://github.com/S25-SWP-Team46/DP-fork/tree/main/.github/ISSUE_TEMPLATE):  
